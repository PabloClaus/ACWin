Namespace Model
    Public Class clsMotivosAlta
        Inherits List(Of clsMotivoAlta)
#Region "Propiedades"
#End Region
        ...
        Public Sub dbGetAll()
            Try
                Using lObjConexion = New SqlClient.SqlConnection(My.Settings.CadenaDeConexion)
                    lObjConexion.Open()
                    Using lObjSqlCommand = New SqlClient.SqlCommand("MotivosAltaGetAll", lObjConexion)
                        With lObjSqlCommand
                            .CommandType = CommandType.StoredProcedure
                            Using lObjSqlDataReader As SqlClient.SqlDataReader = lObjSqlCommand.ExecuteReader
                                Do While lObjSqlDataReader.Read()
                                    Me.Add(New clsMotivoAlta(lObjSqlDataReader))
                                Loop
                            End Using
                        End With
                    End Using
